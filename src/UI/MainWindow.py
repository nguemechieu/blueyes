...
def show(self):
    ...
    win_dow.title("Blueyes| Dashboard                           " + datetime.datetime.now().strftime("%Y-%m-%d "
                                                                                                     "%H:%M:%S"))
    ...
    toolbar = tkinter.Frame(win_dow, relief="raised", width=1000, takefocus=2, border=2,
    ...
    sub_window.children = CandleStickChart(win_dow)
    sub_window.pack()
